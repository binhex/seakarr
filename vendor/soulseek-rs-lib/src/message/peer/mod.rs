...
// Re-export handlers
pub use file_search_response::{FileEntry, FileSearchResponse, build_file_search_response};
...
pub use shared_file_list::{
    SharedDirectory, SharedFileListResponseHandler, build_shared_file_list, parse_shared_file_list,
};
