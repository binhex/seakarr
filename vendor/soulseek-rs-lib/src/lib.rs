...
pub mod prelude {
    ...
    pub use crate::types::{
        ClientVersion, DownloadStatus, File, RoomEvent, RoomInfo, Search, SearchResult, Transfer,
...
pub use types::{
    ClientVersion, DownloadStatus, File, RoomEvent, RoomInfo, Search, SearchResult, SessionLoss,
    Transfer, UploadInfo, UploadStatus, UserInfo, UserPresence, UserStats, UserStatus,
};
